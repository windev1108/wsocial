...
const resolvers = {
    Query: {
        // Query all users
        getUsers: (_parent, _args, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Query all post
        getPosts: (_parent, { userId }, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        //  Query post by Id
        getPostById: (_parent, args, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    User: {
        posts: (_parent, { isMySelf, isFriend }, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
            if (isMySelf) {
                const posts = yield prisma.post.findMany({
                    where: {
                        authorId: _parent.id,
        ...
        friends: (_parent, _args, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
            const user = yield prisma.user.findUnique({
                where: { id: _parent.id },
                select: { friends: true },
            });
        ...
        followers: (_parent, _args, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
            const user = yield prisma.user.findUnique({
                where: { id: _parent.id },
        ...
        followings: (_parent, _args, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
            const user = yield prisma.user.findUnique({
                where: { id: _parent.id },
    ...
    Post: {
        author: (_parent, _args, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        likes: (_parent, _args, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        files: (_parent, _args, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    Mutation: {
        ...
        deletePost: (_parent, { id }, { prisma }) => __awaiter(void 0, void 0, void 0, function* () {
