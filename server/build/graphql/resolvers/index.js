...
var resolvers = {
    Query: {
        // Query all users
        getUsers: function (_parent, _args, _a) {
        ...
        //  Query post by Id
        getPostById: function (_parent, args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, conversations.find(function (conversation) { return conversation.participants.some(function (p) { return p.id === id_1; }) && conversation.participants.some(function (p) { return p.id === userId_1; }); })];
                    case 3:
                        error_1 = _a.sent();
        ...
        conversations: function (_parent, _args, context) { return __awaiter(void 0, void 0, void 0, function () {
            var prisma, session_1, conversations, error_2;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        prisma = context.prisma, session_1 = context.session;
    ...
    User: {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            posts = _c.sent();
                            return [2 /*return*/, posts];
                        case 4: return [4 /*yield*/, prisma.post.findMany({
                                where: {
                                    authorId: _parent.id,
                                    viewer: {
                                        equals: "PUBLIC",
        ...
        friends: function (_parent, _args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                var user;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            return [2 /*return*/, user === null || user === void 0 ? void 0 : user.friends];
                    }
                });
            });
        },
        ...
        followers: function (_parent, _args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                var user;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            return [2 /*return*/, user === null || user === void 0 ? void 0 : user.followers];
                    }
                });
            });
        },
        followings: function (_parent, _args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                var user;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            return [2 /*return*/, user === null || user === void 0 ? void 0 : user.followings];
                    }
                });
            });
        },
        notificationsFrom: function (_parent, _args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                var user;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            return [2 /*return*/, user === null || user === void 0 ? void 0 : user.notificationsFrom];
                    }
                });
            });
        },
        notificationsTo: function (_parent, _args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                var user;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            user = _b.sent();
                            return [2 /*return*/, user === null || user === void 0 ? void 0 : user.notificationsTo];
                    }
                });
            });
        },
    ...
    Post: {
        author: function (_parent, _args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
        ...
        likes: function (_parent, _args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                var post;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            post = _b.sent();
                            return [2 /*return*/, post === null || post === void 0 ? void 0 : post.likes];
                    }
                });
            });
        },
        files: function (_parent, _args, _a) {
            var prisma = _a.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, prisma.file.findMany({
                                where: {
                                    postId: _parent.id,
                                },
                            })];
        ...
        comments: function (_parent, _args, context) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        post = _a.sent();
                        return [2 /*return*/, post === null || post === void 0 ? void 0 : post.comments.filter(function (comment) { return comment.commentOf.length === 0; })];
                }
            });
        }); },
        postSharedOf: function (_parent, _args, context) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        post = _a.sent();
                        return [2 /*return*/, post === null || post === void 0 ? void 0 : post.postSharedOf[0]];
                }
            });
        }); },
    },
    Mutation: {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            ...
                            if (!post.files) return [3 /*break*/, 2];
                        ...
                        case 1:
                            ...
                            return [3 /*break*/, 12];
                        case 2:
                            if (!post.postIdShared) return [3 /*break*/, 10];
                            return [4 /*yield*/, prisma.post.create({
                                    data: {
                        ...
                        case 4:
                            _g.sent();
                            if (!(postShared.authorId !== (session === null || session === void 0 ? void 0 : session.user.id))) return [3 /*break*/, 9];
                            return [4 /*yield*/, prisma.notification.findFirst({
                                    where: {
                                        fromUsers: {
                                            some: {
                        ...
                        case 6:
                            _g.sent();
                            return [3 /*break*/, 9];
                        case 7: return [4 /*yield*/, prisma.notification.create({
                                data: {
                                    fromUsers: {
                                        connect: {
                        ...
                        case 10: return [4 /*yield*/, prisma.post.create({
        ...
        deletePost: function (_parent, _a, _b) {
            var id = _a.id;
            var prisma = _b.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_c) {
        ...
        updateUser: function (_parent, _a, context) {
            var user = _a.user;
            return __awaiter(void 0, void 0, void 0, function () {
                var session, prisma, userUpdate, error_3;
                var _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            _b.sent();
                            if (!(authorId !== (session === null || session === void 0 ? void 0 : session.user.id))) return [3 /*break*/, 8];
                            return [4 /*yield*/, prisma.notification.findFirst({
                                    where: {
                                        toUserId: authorId,
                                        postId: postId,
                        ...
                        case 4:
                            ...
                            if (!!notification) return [3 /*break*/, 6];
                        ...
                        case 5:
                            _b.sent();
                            return [3 /*break*/, 8];
                        case 6: return [4 /*yield*/, prisma.notification.update({
                                where: {
                                    id: notification.id,
                                },
                                data: {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 2: return [4 /*yield*/, prisma.comment.update({
                                where: {
                                    id: commentId,
                                },
                                data: {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 4:
                            _g.sent();
                            return [3 /*break*/, 7];
                        case 5: return [4 /*yield*/, prisma.notification.create({
                                data: {
                                    toUserId: followingId,
                                    fromUsers: {
                                        connect: {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.sent();
                            return [3 /*break*/, 5];
                        case 2: return [4 /*yield*/, prisma.notification.findFirst({
                                where: {
                                    toUserId: userId,
                                    fromUsers: {
                                        every: {
                ...
                return __generator(this, function (_m) {
                    switch (_m.label) {
                        ...
                        case 1:
                            ...
                            if (!replyUserId) return [3 /*break*/, 7];
                            if (!(authorId !== ((_b = session === null || session === void 0 ? void 0 : session.user) === null || _b === void 0 ? void 0 : _b.id))) return [3 /*break*/, 6];
                            return [4 /*yield*/, prisma.notification.findFirst({
                                    where: {
                        ...
                        case 2:
                            ...
                            if (!!notification) return [3 /*break*/, 4];
                            return [4 /*yield*/, prisma.notification.create({
                                    data: {
                                        fromUsers: {
                                            connect: {
                        ...
                        case 3:
                            _m.sent();
                            return [3 /*break*/, 6];
                        case 4: return [4 /*yield*/, prisma.notification.update({
                                where: {
                                    id: notification.id,
                                },
                                data: {
                        ...
                        case 7:
                            if (!(authorId !== ((_e = session === null || session === void 0 ? void 0 : session.user) === null || _e === void 0 ? void 0 : _e.id))) return [3 /*break*/, 12];
                            return [4 /*yield*/, prisma.notification.findFirst({
                                    where: {
                                        postId: postId,
                                        type: "COMMENT_POST",
                        ...
                        case 8:
                            notification = _m.sent();
                            if (!notification) return [3 /*break*/, 10];
                            return [4 /*yield*/, prisma.notification.update({
                                    where: {
                                        id: notification.id
                                    },
                        ...
                        case 9:
                            _m.sent();
                            return [3 /*break*/, 12];
                        case 10: return [4 /*yield*/, prisma.notification.create({
                                data: {
                                    fromUsers: {
                                        connect: {
                        ...
                        case 14: return [4 /*yield*/, prisma.comment.create({
                                data: {
                                    content: content,
                                    postId: postId,
                        ...
                        case 19: return [4 /*yield*/, prisma.comment.create({
                                data: {
                                    content: content,
                                    postId: postId,
        ...
        deleteComment: function (_parent, _a, _b) {
            var id = _a.id;
            var prisma = _b.prisma;
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, prisma.comment.delete({
                                where: {
                                    id: id,
                                },
                            })];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 3: return [4 /*yield*/, prisma.message.create({
                                data: {
                                    content: content,
                                    conversationId: conversationId,
                        ...
                        case 6: return [4 /*yield*/, prisma.conversation.create({
                                data: {
                                    participants: {
